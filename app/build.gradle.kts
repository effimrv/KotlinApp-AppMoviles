plugins {
    ...
    // Habilitar KAPT para Room (activar si usas kapt)
    id("kotlin-kapt")
}

android {
    namespace = "com.effimrv.kotlinapp"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.effimrv.kotlinapp"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // NOTE: CameraX dependencies removed (using TakePicturePreview contract instead)
